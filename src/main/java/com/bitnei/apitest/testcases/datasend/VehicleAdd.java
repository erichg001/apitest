...
public class VehicleAdd {
	...
	public void setUp(String host) {
		url = host + "/forward/dataForwardConfig/task/addVehicle";
		//设置cookie		
		try {
	...
	@Test(description="任务添加车辆",priority =0,dataProvider="dataprovider5",
			dataProviderClass=PlatFormProvider.class)
	public void VehicleAddData(String st) throws ClientProtocolException, IOException {
