...
public class RsaUtil {
    ...
    public static void main(String[] args) {
        try {
            ...
            // RSA加密
            String data = "LSJA24799HS059427";
            String encryptData = encrypt(data, getPublicKey(rsaPublicKey));
            System.out.println("加密后内容:" + encryptData);
            // RSA解密
            String decryptData = decrypt(encryptData, getPrivateKey(rsaPrivateKey));
            ...
            // SHA256withRSA验签
            boolean result = verify(data + "_" + s, getPublicKey(signPublicKey), sign);
